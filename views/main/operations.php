...
$this->breadcrumbs=array(
	...
	Yii::t('RightsModule.tr', 'Operations'),
);
?>
...
<div class="rights">
	...
	<div id="rightsOperations">
			...
			<table class="rightsTable operationTable" border="0" cellpadding="0" cellspacing="0">
				...
				<?php foreach( $authItems as $name=>$item ): ?>
					...
					<tr class="<?php echo ($i++ % 2)===0 ? 'odd' : 'even'; ?>">
						...
						<td>
							<?php echo CHtml::link($name, array('authItem/update', 'name'=>$name, 'redirect'=>urlencode('main/operations'))); ?>
		...
		<?php else: ?>
			...
			<p><?php echo Yii::t('RightsModule.tr', 'No operations found.'); ?></p>
